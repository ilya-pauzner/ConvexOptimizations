...
def do_nonsmooth_gnm(func, dimension, x0=None, max_iter=1000, tolerance=2e-3, eta=5e-1):
    losses = []
    if x0 is None:
...
if __name__ == '__main__':  # testing
    print(do_nonsmooth_gnm(lambda x: oracle.apply_func_F(x, oracle.trigonometry), 2, eta=1e-2))
    print(do_nonsmooth_gnm(lambda x: oracle.apply_func_F(x, oracle.chebyshev), 2, eta=1e-2))
